...
export default function Welcome(props: any) {
  return (
    ...
    <nav className="flex items-center justify-between flex-wrap bg-black p-3 fixed w-full z-10 top-0 pin-t">
      <div className="flex items-center flex-shrink-0 text-white mr-6">
        <a className="text-white no-underline hover:text-white hover:no-underline" href="#">
          <span className="text-2xl pl-2 font-semibold">Cranium</span></a>
      </div>
      ...
      <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0"
        ...
        <ul className="list-reset lg:flex justify-end flex-1 items-center">
          <li className="mr-6">
            <a className="inline-block py-2 px-2 text-white no-underline hover:text-blue-300">Services</a>
          </li>
          <li className="mr-6">
            <a className="inline-block py-2 px-2 text-white no-underline hover:text-blue-300">Features</a>
          </li>
          <li className="mr-6">
            <a className="inline-block py-2 px-2 text-white no-underline hover:text-blue-300">Contact</a>
          </li>
          {props.auth.user ? (
            ...
            <>
              <InertiaLink href={route('login')}
                           className=" mr-6 inline-block py-2 px-2 text-white no-underline hover:text-blue-300">
                Log in
              </InertiaLink>
    ...
    <div className="bg-white h-screen flex flex-col justify-center items-center">
      <h4 className="lg:text-8 xl md:text-6xl sm:text-4xl text-2xl font-black mb-14">
        At eripuit signiferumque sea, vel ad
      </h4>
      <h4 className="lg:text-8 xl md:text-6xl sm:text-4xl text-2xl font-black mb-14">
        mucius eiusmod.
      </h4>
      <h4 className="lg:text-6 xl md:text-4xl sm:text-2xl text-gray-400 mb-14">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
      </h4>

      <a href="#" className="bg-black p-9 text-white inline-block  rounded shadow  hover:text-blue-300">CTA</a>
