        ...
        <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0"
          ...
          <ul className="list-reset lg:flex justify-end flex-1 items-center">
            ...
            {props.auth.user ? (
                          ...
                          <>
                              <InertiaLink href={route('login')} className=" mr-6 inline-block py-2 px-2 text-white no-underline hover:text-blue-300">
                                  Log in
                              </InertiaLink>

                              <InertiaLink href={route('register')} className="mr-6 inline-block py-2 px-2 text-white no-underline hover:text-blue-300">
                                  Register
                              </InertiaLink>
                          </>
                      )}
